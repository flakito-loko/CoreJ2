# JavaOne v0.9.0-alpha

**Release notes draft**

## Summary

JavaOne reaches its first publicly documented playable commercial milestone: classic Java ME (J2ME) games run on a **physical iPhone** with an **embedded OpenJDK Mobile** runtime and **FreeJ2ME**, presented through a native **SwiftUI** app.
...
Device screenshots, optimized GIFs, and MP4 recordings are published under `docs/assets/` and on the [documentation site](https://flakito-loko.github.io/JavaOne/).
...
- Source: https://github.com/flakito-loko/JavaOne
